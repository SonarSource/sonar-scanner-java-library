...
public class SSLTest {
  ...
  public void simple_analysis_with_server_certificate(String clientTrustStore, String keyStorePassword, boolean useJavaSslProperties) throws Exception {
    // SONAR-23013 Truststore generated by default by openssl are not supported before SonarQube 10.7
    assumeTrue(!clientTrustStore.endsWith("openssl.p12") || ORCHESTRATOR.getServer().version().isGreaterThanOrEquals(10, 7));
